...
ws.on('message', async (data) => {
    try {
        ...
        if (json.code === 551) { // 緊急地震速報
            ...
            switch (maxScale) {
                case 10: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300018?size=l'; break
            case 20: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300017?size=l'; break
            case 30: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300015?size=l'; break
            case 40: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300014?size=l'; break
            case 45: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300013?size=l'; break
            case 50: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc303658?size=l'; break
            case 55: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc303657?size=l'; break
            case 60: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc303656?size=l'; break
            case 70: shindoImageUrl = 'https://deliver.commons.nicovideo.jp/thumbnail/nc300009?size=l'; break
